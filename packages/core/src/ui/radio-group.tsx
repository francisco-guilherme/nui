...
function RadioGroupItem({
  ...
  return (
    <Radio.Root
      className={cn(
        "aspect-square size-4 shrink-0 rounded-full border bg-input text-primary shadow-xs outline-none transition-[color,box-shadow] focus-visible:ring-2 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/50 data-checked:border-primary",
        className
      )}
