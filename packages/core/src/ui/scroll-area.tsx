  ...
  return (
    ...
    >
      <BaseScrollArea.Viewport
        className="size-full overscroll-contain rounded-[inherit] outline-none transition-[color,box-shadow] focus-visible:outline focus-visible:ring-2 focus-visible:ring-ring/50"
