...
function TabsList({
  ...
  return (
    <BaseTabs.List
      className={cn(
        "relative inline-flex h-9 w-fit items-center justify-center gap-x-1 p-1 text-muted-foreground",
...
function TabsTrigger({
  ...
  return (
    <BaseTabs.Tab
      className={cn(
        "z-[1] flex-1 items-center justify-center gap-1.5 whitespace-nowrap text-nowrap rounded-md px-2 py-1 text-muted-foreground text-sm [&_svg:not([class*='size-'])] focus-visible:ring-2 focus-visible:ring-ring/50 data-[disabled]:pointer-events-none data-selected:text-foreground data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
    ...
    <BaseTabs.Indicator
      className={cn(
        ...
        variant === "underline"
          ...
          : "-z-10 top-1/2 h-[var(--active-tab-height)] rounded-md border bg-input shadow-sm",
        className
      )}
