...
// Move the wrapper components outside of Calendar
function NextMonthButtonWrapper(classNames?: { button_next?: string }) {
  return function NextMonthButtonWrapperComponent(
    buttonProps: React.ButtonHTMLAttributes<HTMLButtonElement>
  ) {
    return (
      <NextMonthButton {...buttonProps} className={classNames?.button_next} />
    );
  };
}

function PreviousMonthButtonWrapper(classNames?: { button_previous?: string }) {
  return function PreviousMonthButtonWrapperComponent(
    buttonProps: React.ButtonHTMLAttributes<HTMLButtonElement>
  ) {
    return (
      <PreviousMonthButton
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        NextMonthButton: NextMonthButtonWrapper(classNames),
        PreviousMonthButton: PreviousMonthButtonWrapper(classNames),
      }}
      {...props}
    />
  );
